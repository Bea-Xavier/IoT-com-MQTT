        ...
        <Modal visible={visible} transparent animationType="fade">
            <View style={styles.modalContainer}>
                <View style={styles.modalContainer}>
                    ...
                    <TouchableOpacity style={styles.bntRetry} onPress={onRetry}>
                        <Text style={styles.bntText}>Tentar Novamente</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.bntLater} onPress={onLater}>
                        <Text style={styles.bntText}>Tentar Mais Tarde</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
...
const styles = StyleSheet.create({
    ...
    bntRetry: { backgroundColor: '#27AE60', padding: 15,
        borderRadius: 12, width: '100%', marginBottom: 12
    },
    bntLater: { backgroundColor: '#444', padding: 15,
        borderRadius: 12, width: '100%', marginBottom: 12
    },
    bntText: { color: '#FFF', textAlign: 'center',
